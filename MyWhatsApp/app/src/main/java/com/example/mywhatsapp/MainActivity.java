...
import com.example.mywhatsapp.Fragments.ProfileFragment;
import com.example.mywhatsapp.Fragments.UsersFragment;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(unread == 0){
                    ...
                    viewPagerAdpater.addFragment(new ChatsFragment(), "Chats ("+unread+")");
                }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                ...
                startActivity(new Intent(MainActivity.this, StartActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)); //changed
                return true;
        }
        return false;
    }
