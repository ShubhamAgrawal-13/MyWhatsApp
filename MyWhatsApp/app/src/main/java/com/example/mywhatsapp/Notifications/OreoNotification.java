...
import com.example.mywhatsapp.BuildConfig;

public class OreoNotification extends ContextWrapper {

    private static final String CHANNEL_ID = "com.example.mywhatsapp";
    private static final String CHANNEL_NAME = "MyWhatsApp";
